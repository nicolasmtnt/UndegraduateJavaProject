...
public interface IUtilisateur{
  ...
  public String passWord; //Pour le moment stocké en String, pas très sécur
  ...
  public void mettreProduitPanier(){}; //Va mettre dans le panier le produit en question (possibilité d'ajouter n produit(s) par exemple)
}
